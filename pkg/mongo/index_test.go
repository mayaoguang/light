...
func TestNewCollection(t *testing.T) {
	var (
		...
		recordM = &Person{ID: bson.NewObjectId(), Name: "light", Phone: "+86 123456"}
	)
	...
	if err = cli.Update(bson.M{"name": "light"}, bson.M{"$set": bson.M{"phone": "+86 23456789"}}); err != nil {
	...
	if _, err = cli.RemoveAll(bson.M{"name": "light"}); err != nil {
